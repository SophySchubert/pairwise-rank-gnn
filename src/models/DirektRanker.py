...
class DirectRanker(BaseEstimator):
    """
    from https://github.com/kramerlab/direct-ranker
    https://github.com/kramerlab/direct-ranker/blob/master/Rankers/models/DirectRanker.py
    paper: Pairwise Learning to Rank by Neural Networks Revisited: Reconstruction, Theoretical Analysis and Practical Performance
    https://arxiv.org/pdf/1909.02768
    """
